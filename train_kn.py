...
questions = open('/home3/181ee103/it_project/baseline/kn/cleaned_questions_kn.txt', 'rb').read().decode('utf-8').splitlines()
answers = open('/home3/181ee103/it_project/baseline/kn/cleaned_answers_kn.txt','rb').read().decode('utf-8').splitlines()
image_id = open('/home3/181ee103/it_project/baseline/kn/cleaned_image_id_kn.txt','rb').read().decode('utf-8').splitlines()
...
le = LabelEncoder()
le.fit(answers)
pickle.dump(le, open('/home3/181ee103/label_encoder_kn_baseline.pkl','wb'))
...
model.save("/home3/181ee103/kn_baseline.h5")
#plt.plot(losses)
#plt.show()

label_encoder = pickle.load(open('/home3/181ee103/label_encoder_kn_baseline.pkl','rb'))
...
with open('/home3/181ee103/kn_baseline_predictions.pkl', 'wb', encoding = "utf8") as f:
    pickle.dump(y_pred, f)

#with open('kn_predictions.pkl', 'rb', encoding = "utf8") as f:
