...
def process_question_annotation(subset):
    with open('/home3/181ee103/it_project/attention/kn/cleaned_answers_v2_kn.txt', 'r', encoding = "utf8") as f:
      anno = f.readlines()
    with open('/home3/181ee103/it_project/attention/kn/cleaned_questions_v2_kn.txt', 'r', encoding = "utf8") as f:
      ques = f.readlines()
    with open('/home3/181ee103/it_project/attention/kn/cleaned_image_id_v2_kn.txt', 'r', encoding = "utf8") as f:
      img_ids = f.readlines()
