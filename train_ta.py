...
le = LabelEncoder()
le.fit(answers)
pickle.dump(le, open('/home3/181ee103/label_encoder_ta_baseline.pkl','wb'))
...
model.save("/home3/181ee103/ta_baseline.h5")
#plt.plot(losses)
#plt.show()
...
with open('/home3/181ee103/ta_baseline_predictions.pkl', 'wb', encoding = "utf8") as f:
