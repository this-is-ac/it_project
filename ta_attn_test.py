...
def process_question_annotation(subset):
    with open('/home3/181ee103/it_project/validation/ta/cleaned_answers_v2_ta.txt', 'r', encoding = "utf8") as f:
      anno = f.readlines()
    with open('/home3/181ee103/it_project/validation/ta/cleaned_questions_v2_ta.txt', 'r', encoding = "utf8") as f:
      ques = f.readlines()
    with open('/home3/181ee103/it_project/validation/ta/cleaned_image_id_v2_ta.txt', 'r', encoding = "utf8") as f:
      img_ids = f.readlines()
...
train_val_data = json.load(open(f'/home3/181ee103/vqa_raw_train2014.json', 'r'))

from sklearn.model_selection import train_test_split

train_data ,val_data = train_test_split(train_val_data,test_size=0.99, random_state  = 42)
...
with open('/home3/181ee103/processed_questions.pkl', 'wb') as f:
  joblib.dump((questions_train_processed, questions_val_processed), f)

with open('/home3/181ee103/processed_questions.pkl', 'rb') as f:
...
with open('/home3/181ee103/text_tokenizer.pkl', 'wb') as f:
  joblib.dump(tok, f)

with open('/home3/181ee103/text_tokenizer.pkl', 'rb') as f:
  tok = joblib.load(f)
...
with open('/home3/181ee103/tokenised_data_post.pkl', mode='wb') as f:
  pickle.dump((question_data_train, question_data_val), f)

with open('/home3/181ee103/tokenised_data_post.pkl', mode='rb') as f:
  question_data_train, question_data_val = pickle.load(f)

#labelencoder = preprocessing.LabelEncoder()
#labelencoder.fit(answer_train)

#with open('/home3/181ee103/labelencoder.pkl', 'wb') as f:
#  joblib.dump(labelencoder, f)

with open('/home3/181ee103/labelencoder.pkl', 'rb') as f:
...
base_path = '/home3/181ee103/temps'
...
for epoch in range(START_EPOCH, EPOCHS):
  ...
  wandb.log({"F1 Score": train_score.result()})
  wandb.log({"Val Loss": val_loss.result()})
  wandb.log({"Val F1 Score": val_score.result()})
...
pickle.dump(y_predict_text_vl, open('/home3/181ee103/ta_attn_predictions.pkl','wb'))
pickle.dump(val_answers, open('/home3/181ee103/ta_attn_groundtruths.pkl','wb'))

with open("/home3/181ee103/ta_attn_acc.txt", "w") as f:
