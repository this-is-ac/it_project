...
a_test_questions = open('/home3/181ee103/it_project/validation/hi/val_cleaned_questions_hi.txt', 'rb').read().decode('utf-8').splitlines()
a_test_answers = open('/home3/181ee103/it_project/validation/hi/val_cleaned_answers_hi.txt','rb').read().decode('utf-8').splitlines()
a_test_image_id = open('/home3/181ee103/it_project/validation/hi/val_cleaned_image_id_hi.txt','rb').read().decode('utf-8').splitlines()
...
img_ids = open('/home3/181ee103/it_project/baseline/hi/coco_vgg_IDMap.txt','rb').read().decode('utf-8').splitlines()
id_map = dict()
for ids in img_ids:
    id_split = ids.split()
...
model = keras.models.load_model("/home3/181ee103/trained_models/hi/hi_baseline.h5")
label_encoder = pickle.load(open('/home3/181ee103/trained_models/hi/label_encoder_hi_baseline.pkl','rb'))
...
pickle.dump(y_pred, open('/home3/181ee103/hi_baseline_predictions.pkl','wb'))
pickle.dump(test_answers, open('/home3/181ee103/hi_baseline_groundtruths.pkl','wb'))
